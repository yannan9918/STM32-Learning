...
uint8_t MyArray[]={0x42,0x41,0x42,0x41};
extern char  Serial_RxPacket[100];
extern char Serial_TxPacket[100];
void Serial_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_IPU;//复用推挽式输出
...
uint16_t Serial_Pow(uint8_t X,uint8_t Y)
{
	uint16_t Result=1;
   while(Y--)
   {
